...
"""
struct FNO_Block3D{N} <: Lux.AbstractLuxLayer
...
function FNO_Block3D(channels::Int, modes::NTuple{N,Integer}; expansion_factor::Number=0.5, activation=NNlib.gelu) where N
