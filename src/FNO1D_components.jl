...
function (layer::SoftGating1D)(x::AbstractArray, ps::NamedTuple, st::NamedTuple)
...
function (layer::ChannelMLP1D)(x::AbstractArray, ps::NamedTuple, st::NamedTuple)
...
"""
struct FNO_Block1D <: Lux.AbstractLuxLayer
...
function FNO_Block1D(channels::Int, modes::NTuple{1,Int}; expansion_factor=0.5, activation=NNlib.gelu)
...
function (fno_block::FNO_Block1D)(x::AbstractArray, ps::NamedTuple, st::NamedTuple)
